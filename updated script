...
echo "Changing owner of 'labs' directory to zofo-karabo:root..."
sudo chown zofo-karabo:root /var/www/html/labs

echo "Creating a symbolic link from 'labs' to /home/zofo-karabo/html..."
ln -s /var/www/html/labs /home/zofo-karabo/html
